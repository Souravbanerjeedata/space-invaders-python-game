...
# PLAYER SHIP
YELLOW_SPACE_SHIP = pygame.transform.scale(pygame.image.load(os.path.join('assets', 'pixel_ship_yellow.png')), (60, 50))
...
class Enemy(Ship):
    COLOR_MAP = {"red": (RED_SPACESHIP_IMAGE, RED_LASER), "green": (GREEN_SPACESHIP_IMAGE, GREEN_LASER), "blue": (BLUE_SPACESHIP_IMAGE, BLUE_LASER)}
